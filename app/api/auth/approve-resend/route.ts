...
import { sendApprovalConfirmationResend } from '@/lib/email-resend';
...
export async function GET(req: NextRequest) {
  ...
  try {
    await sendApprovalConfirmationResend(user.email);
  } catch (err) {
    console.error('Failed to send approval confirmation via Resend:', err);
  }
